...
>
  <head>
    ...
    <title>Formulário Atualizar Login</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form_login.php" class="menu-link">
                    <div data-i18n="Without menu">Cadastro</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="consulta_login.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Cliente</div>
              </a>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Fornecedor</div>
              </a>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Vendas</div>
              </a>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Formularios/atualizar/</span> Login</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Atualizar login</h5>
                      <small class="text-muted float-end">Formulário de atualizar login</small>
                    </div>
                    <div class="card-body">
                      <form name="frm_login" id="frm_login" action="atualizar_login.php" method="post">
                      <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Codigo</label>
                          <div class="input-group input-group-merge">
                            ...
                            <input
                              ...
                              value="<?php echo $dados['log_codigo']; ?>"
                            />
                          </div>
                        </div>  
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            name="txt_login"
                              ...
                              value="<?php echo $dados['log_login']; ?>""
                            />
                          </div>
                        </div>
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            name="txt_senha"
                              ...
                              aria-label="Senha"
                              aria-describedby="basic-icon-default-company2"
                              value="<?php echo $dados['log_senha']; ?>"
                            />
                          </div>
                        </div>
                        <button type="submit" class="btn btn-primary" onclick="return validar_dados()">Enviar</button>
                      </form>
                    </div>
                  </div>
                </div>
